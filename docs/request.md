...
- `--output` (alias `-o`) - Location to store the output file. If not provided AND current directory is a sasjs project, a file named output.json will be saved in the sasjsresults folder else in current directory..
